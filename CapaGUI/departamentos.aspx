<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="departamentos.aspx.cs" Inherits="CapaGUI.departamentos" %>
...
<body class="is-preload homepage">
		<div id="page-wrapper">
						...
						<!-- Nav -->
							<nav id="nav">
								<ul>
									...
									<li class="current"><a href="departamentos.aspx">Departamentos</a></li>
			...
			<!-- Banner -->
			<div id="contenedorDpto" class="lista">
				<!--Aqui van los dptos-->
			</div>
		<!-- Footer -->
