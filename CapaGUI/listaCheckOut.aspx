<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="listaCheckOut.aspx.cs" Inherits="CapaGUI.listaCheckOut" %>
...
<body>
    <body class="is-preload homepage">
		<div id="page-wrapper">
			...
			<!-- Banner -->
			<div id="contenedorListaCheckOut" class="lista">
				<!--Aqui van los dptos-->
                <asp:Label ID="lblNoHayCheckOut" runat="server" Text="Label" Visible="False"></asp:Label>
			</div>
		<!-- Footer -->
    ...
    <script src="js/listaCheckOut.js"></script>
