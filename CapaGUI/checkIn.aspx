<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="checkIn.aspx.cs" Inherits="CapaGUI.checkIn" %>
...
<link rel="stylesheet" href="estilos/index.css" />
	...
	<body class="is-preload no-sidebar">
						...
						<!-- Nav -->
							<nav id="nav">
								<ul>
									...
									<li class="current"><a href="no-sidebar.html">Cerrar Sesion</a></li>
								</ul>
							</nav>
		...
		<!-- Scripts -->
			...
			<script src="js/ingresoCheckIn2.js"></script>
