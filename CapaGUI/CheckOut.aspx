<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CheckOut.aspx.cs" Inherits="CapaGUI.CheckOut" %>
				...
				<div class="panel-body">
					<form id="form1" runat="server">
						<div class="form-group">
							<h2>Ingreso Check Out</h2>
						</div>
						<%--<div class="form-groupp">
							<label class="control-label" for="signupPassword">Id Reserva</label>
							<div class="textBoxx"><asp:TextBox ID="txtIdCheckIn" runat="server" type="text" maxlength="25"  length="90"></asp:TextBox></div>
						</div>--%>
						<%--<div class="form-groupp">
							<label class="control-label" for="signupPassword">Fecha Check Out</label>
						<div class="textBox"><asp:TextBox ID="txtFecha" textmode="Date" runat="server"></asp:TextBox></div>--%>
							
						</div>
						<br />
						<div class="form-groupp">
							<b><label class="control-label" >Agregar multa</label></b>
							<br />
							<img src="Image/Multa.png" width="50px" onclick="agregarMultaCheckOut()" />
							 <p id="agregarMulta"></p>
						</div>
...
<%--							<button id="signupSubmit" type="submit" class="btn btn-info btn-block">Crea tu cuenta</button>--%>
							<%--<asp:Button ID="btnRegistrar" class="" runat="server" Text="Ingresar Check Out" OnClick="btnRegistrar_Click"   />--%>
						<input type="button" value="Ingresar Check Out" onclick="registrarCheckoutMultaDetalle(); return false;" />
						</div>
					</form>
				   </div>
				</div>
